...
const WeatherInfosMoked:WeatherInfos = {
    location: {
        "name": "Sao Paulo",
        "region": "Sao Paulo",
        "country": "Brazil",
...
export default function Display() {
    const [weaterInfos, setWeatherInfos] = useState<WeatherInfos>(null)
    return (
        <div className="bg-dark text-dark-header dark:bg-light dark:text-light-txt max-w-2xl p-4 py-8 rounded-lg text-center">
            ...
            { weaterInfos !== 'error' && weaterInfos !== null && (
                <WheaterDescription wheatherInfos={WeatherInfosMoked}/>
            ) }
